...
namespace BugTrackerDemo.Controllers
{
    ...
    public class TicketsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Description," +
                                                      "ProjectId,TicketTypeId," +
                                                      "TicketPriorityId")] Ticket ticket)
        {
            BTUser btUser = await _userManager.GetUserAsync(User);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Description,Created,Updated," +
                                                            "Archived,ProjectId,TicketTypeId,TicketPriorityId," +
                                                            "TicketStatusId,OwnerUserId,DeveloperUserId")] Ticket ticket)
        {
            if (id != ticket.Id)
            {
                return NotFound();
